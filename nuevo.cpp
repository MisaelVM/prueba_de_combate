...
int role::get_level()
{
    return level_of_role.get_level();
}
...
{
    for(int i = 0; i < _stats.get_size();i++)
        _stats.set_v_value(i, constant[i]+((roles[point_role[0]].get_code_stats()[i]-'0')*_level.get_level()));
